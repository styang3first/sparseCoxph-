...
rm(GMCP.sel.800)
rm(GMCP.sel.400)
#save.image("E:/Google ¶³ºÝµwºÐ/program/yang/group penalized regression 2013/group cox/©T©wweightver2/simulation all/OK/betaresult.cox.RData")
#save.image("E:/Google ¶³ºÝµwºÐ/program/yang/group penalized regression 2013/group cox/©T©wweightver2/simulation all/OK/betaresult2.cox.RData")
